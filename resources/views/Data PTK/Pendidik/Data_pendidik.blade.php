    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('datapendidik.show', $item->id) }}" class="btn btn-success btn-sm " title="Detail"><i class="fas fa-eye"></i></a>
            <a href="{{ route('datapendidik.edit', $item->id) }}" class="btn btn-warning btn-sm "><i class="fas fa-edit"></i></a>
