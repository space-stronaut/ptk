@extends('Layout.app')
@section('title', 'Data Kegiatan Tambahan Tendik')
...
<div class="card">
    ...
    <div class="card-header">
      ...
      @endif
      <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Data Kegiatan Tambahan Tenaga Kependidikan (TENDIK)</h3>
      <div class="card-tools">
        <a href="{{ route('tendiktambahan.create') }}" class="btn btn-primary btn-sm "><i class="fas fa-plus" title="Tambah Data"></i> Tambah Data</a>
      </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
        @foreach ($tendiktambahans as $item)
        <tr>
