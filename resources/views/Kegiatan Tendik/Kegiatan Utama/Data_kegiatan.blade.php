@extends('Layout.app')
@section('title', 'Tugas Utama TENDIK')
...
<div class="card">
    ...
    <div class="card-header">
      ...
      @endif
      <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Data Kegiatan Utama Tenaga Kependidikan (TENDIK)</h3>
      <div class="card-tools">
        <a href="{{ route('tendikutama.create') }}" class="btn btn-primary btn-sm "><i class="fas fa-plus" title="Tambah Data"></i> Tambah Data</a>
      </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
