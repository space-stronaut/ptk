@extends('Layout.app')
@section('title', 'Tambah Data Kegiatan Utama TENDIK')

@section('content')
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title"><i class="fas fa-plus" title="Tambah Data"></i> Form Tambah Data Kegiatan Utama Tenaga Kependidikan (TENDIK)</h3>
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-6">
        <form action="{{ route('tendikutama.store') }}" method="POST">
          {{ csrf_field('PUT') }}
